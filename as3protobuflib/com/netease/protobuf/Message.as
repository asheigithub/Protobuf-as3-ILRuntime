...
package com.netease.protobuf {
	...
	public dynamic class Message {
		...
		internal final function _readFromSlice(input:IDataInput, bytesAfterSlice:uint):void
		{
			readFromSlice(input, bytesAfterSlice);
		}
		
		/**
		 * @private
		 */
		protected function readFromSlice(
				input:IDataInput, bytesAfterSlice:uint):void {
			throw new IllegalOperationError("Not implemented!")
		}

		internal final function _writeToBuffer(output:WritingBuffer):void
		{
		 ...
		 * @private
		 */
		protected function writeToBuffer(
		...
		public static function printBytes(
